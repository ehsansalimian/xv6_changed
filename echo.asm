...
free(void *ap)
{
 ...
 601:	a1 00 0a 00 00       	mov    0xa00,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 66f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 672:	a3 00 0a 00 00       	mov    %eax,0xa00
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 1d 00 0a 00 00    	mov    0xa00,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6db:	3b 15 00 0a 00 00    	cmp    0xa00,%edx
...
morecore(uint nu)
{
 ...
 70d:	e8 ee fe ff ff       	call   600 <free>
  return freep;
 712:	8b 15 00 0a 00 00    	mov    0xa00,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 734:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 737:	89 15 00 0a 00 00    	mov    %edx,0xa00
      return (void*)(p + 1);
 ...
 74c:	eb e9                	jmp    737 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 00 0a 00 00 04 	movl   $0xa04,0xa00
 755:	0a 00 00 
    base.s.size = 0;
 758:	ba 04 0a 00 00       	mov    $0xa04,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 04 0a 00 00 04 	movl   $0xa04,0xa04
 764:	0a 00 00 
    base.s.size = 0;
 767:	c7 05 08 0a 00 00 00 	movl   $0x0,0xa08
 76e:	00 00 00 
