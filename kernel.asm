...
801004b9:	e8 f2 53 00 00       	call   801058b0 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 e6 53 00 00       	call   801058b0 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 da 53 00 00       	call   801058b0 <uartputc>
...
801008ad:	a3 a4 ff 10 80       	mov    %eax,0x8010ffa4
          wakeup(&input.r);
801008b2:	e8 49 35 00 00       	call   80103e00 <wakeup>
...
80100b84:	e8 97 5e 00 00       	call   80106a20 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100bc8:	e8 83 5f 00 00       	call   80106b50 <clearpteu>
  sp = sz;
...
80100c31:	e8 7a 60 00 00       	call   80106cb0 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 07 60 00 00       	call   80106cb0 <copyout>
...
80100d1f:	e8 9c 59 00 00       	call   801066c0 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 f4 5c 00 00       	call   80106a20 <freevm>
  return 0;
...
80100d56:	c7 44 24 04 cd 6d 10 	movl   $0x80106dcd,0x4(%esp)
80100d5d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100e17:	c7 04 24 d4 6d 10 80 	movl   $0x80106dd4,(%esp)
...
80100ed7:	e9 a4 1c 00 00       	jmp    80102b80 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100edc:	c7 04 24 dc 6d 10 80 	movl   $0x80106ddc,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  ...
  panic("fileread");
80100fc7:	c7 04 24 e6 6d 10 80 	movl   $0x80106de6,(%esp)
...
801010dc:	e9 0f 22 00 00       	jmp    801032f0 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010e1:	c7 04 24 ef 6d 10 80 	movl   $0x80106def,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010ed:	c7 04 24 f5 6d 10 80 	movl   $0x80106df5,(%esp)
...
80101164:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101165:	c7 04 24 ff 6d 10 80 	movl   $0x80106dff,(%esp)
...
80101225:	c7 04 24 12 6e 10 80 	movl   $0x80106e12,(%esp)
...
8010134c:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
8010134d:	c7 04 24 28 6e 10 80 	movl   $0x80106e28,(%esp)
...
80101405:	eb 93                	jmp    8010139a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101407:	c7 04 24 38 6e 10 80 	movl   $0x80106e38,(%esp)
...
8010147c:	c7 44 24 04 4b 6e 10 	movl   $0x80106e4b,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 52 6e 10 	movl   $0x80106e52,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 b8 6e 10 80 	movl   $0x80106eb8,(%esp)
...
801015dc:	e9 bf fc ff ff       	jmp    801012a0 <iget>
  ...
  panic("ialloc: no inodes");
801015e1:	c7 04 24 58 6e 10 80 	movl   $0x80106e58,(%esp)
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 70 6e 10 80 	movl   $0x80106e70,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101776:	c7 04 24 6a 6e 10 80 	movl   $0x80106e6a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017c3:	c7 04 24 7f 6e 10 80 	movl   $0x80106e7f,(%esp)
...
80101c61:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101c62:	c7 04 24 99 6e 10 80 	movl   $0x80106e99,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 87 6e 10 80 	movl   $0x80106e87,(%esp)
...
80101c93:	0f 84 51 01 00 00    	je     80101dea <namex+0x16a>
    ...
    ip = idup(myproc()->cwd);
80101c99:	e8 12 1a 00 00       	call   801036b0 <myproc>
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ee5:	c7 04 24 a8 6e 10 80 	movl   $0x80106ea8,(%esp)
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ef1:	c7 04 24 aa 74 10 80 	movl   $0x801074aa,(%esp)
...
80101fdf:	c7 04 24 14 6f 10 80 	movl   $0x80106f14,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101feb:	c7 04 24 0b 6f 10 80 	movl   $0x80106f0b,(%esp)
...
80102006:	c7 44 24 04 26 6f 10 	movl   $0x80106f26,0x4(%esp)
8010200d:	80 
...
801020bc:	e8 3f 1d 00 00       	call   80103e00 <wakeup>
...
801021ab:	e8 b0 1a 00 00       	call   80103c60 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021db:	c7 04 24 2a 6f 10 80 	movl   $0x80106f2a,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 55 6f 10 80 	movl   $0x80106f55,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
801021f3:	c7 04 24 40 6f 10 80 	movl   $0x80106f40,(%esp)
...
80102248:	c7 04 24 74 6f 10 80 	movl   $0x80106f74,(%esp)
...
80102302:	81 fb a8 ba 11 80    	cmp    $0x8011baa8,%ebx
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010237e:	c7 04 24 a6 6f 10 80 	movl   $0x80106fa6,(%esp)
...
801023eb:	c7 44 24 04 ac 6f 10 	movl   $0x80106fac,0x4(%esp)
801023f2:	80 
...
80102534:	0f b6 81 e0 70 10 80 	movzbl -0x7fef8f20(%ecx),%eax
...
80102568:	0f b6 91 e0 70 10 80 	movzbl -0x7fef8f20(%ecx),%edx
  shift ^= togglecode[data];
8010256f:	0f b6 81 e0 6f 10 80 	movzbl -0x7fef9020(%ecx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
8010257f:	8b 04 85 c0 6f 10 80 	mov    -0x7fef9040(,%eax,4),%eax
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
80102a7b:	c7 44 24 04 e0 71 10 	movl   $0x801071e0,0x4(%esp)
80102a82:	80 
...
80102b37:	e8 24 11 00 00       	call   80103c60 <sleep>
void
begin_op(void)
{
  acquire(&log.lock);
...
80102c8a:	e8 71 11 00 00       	call   80103e00 <wakeup>
    release(&log.lock);
...
80102ca2:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102ca3:	c7 04 24 e4 71 10 80 	movl   $0x801071e4,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102d60:	c7 04 24 f3 71 10 80 	movl   $0x801071f3,(%esp)
80102d67:	e8 f4 d5 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102d6c:	c7 04 24 09 72 10 80 	movl   $0x80107209,(%esp)
...
80102d97:	c7 04 24 24 72 10 80 	movl   $0x80107224,(%esp)
80102d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102da2:	e8 a9 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102da7:	e8 34 28 00 00       	call   801055e0 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 c5 38 00 00       	call   801066a0 <switchkvm>
  seginit();
...
80102e06:	80 
80102e07:	c7 04 24 a8 ba 11 80 	movl   $0x8011baa8,(%esp)
80102e0e:	e8 cd f5 ff ff       	call   801023e0 <kinit1>
  kvmalloc();      // kernel page table
80102e13:	e8 18 3d 00 00       	call   80106b30 <kvmalloc>
...
80102e40:	e8 ab 07 00 00       	call   801035f0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 f6 26 00 00       	call   80105540 <tvinit>
  binit();         // buffer cache
...
80102f3f:	00 
80102f40:	c7 44 24 04 38 72 10 	movl   $0x80107238,0x4(%esp)
80102f47:	80 
...
80102ffa:	00 
80102ffb:	c7 44 24 04 3d 72 10 	movl   $0x8010723d,0x4(%esp)
80103002:	80 
...
8010308c:	ff 24 8d 7c 72 10 80 	jmp    *-0x7fef8d84(,%ecx,4)
80103093:	90                   	nop
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 42 72 10 80 	movl   $0x80107242,(%esp)
...
80103138:	eb e3                	jmp    8010311d <mpinit+0x18d>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
8010313a:	c7 04 24 5c 72 10 80 	movl   $0x8010725c,(%esp)
...
801031df:	c7 44 24 04 90 72 10 	movl   $0x80107290,0x4(%esp)
801031e6:	80 
...
8010328d:	e8 6e 0b 00 00       	call   80103e00 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032cb:	e8 30 0b 00 00       	call   80103e00 <wakeup>
...
8010334f:	e8 ac 0a 00 00       	call   80103e00 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103354:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103358:	89 34 24             	mov    %esi,(%esp)
8010335b:	e8 00 09 00 00       	call   80103c60 <sleep>
{
  int i;
...
801033ca:	e8 31 0a 00 00       	call   80103e00 <wakeup>
  release(&p->lock);
...
8010341f:	e8 3c 08 00 00       	call   80103c60 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801034a5:	e8 56 09 00 00       	call   80103e00 <wakeup>
  release(&p->lock);
...
801034da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801034e0:	81 c3 14 02 00 00    	add    $0x214,%ebx
801034e6:	81 fb 54 b2 11 80    	cmp    $0x8011b254,%ebx
...
80103505:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
  p->priority=5;
8010350c:	c7 83 0c 02 00 00 05 	movl   $0x5,0x20c(%ebx)
80103513:	00 00 00 
  release(&ptable.lock);
  return 0;
...
// }
  ...
  release(&ptable.lock);
80103522:	e8 49 0e 00 00       	call   80104370 <release>
...
8010353e:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103541:	c7 40 14 31 55 10 80 	movl   $0x80105531,0x14(%eax)
...
8010355b:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010355e:	e8 5d 0e 00 00       	call   801043c0 <memset>
...
801035f6:	c7 44 24 04 95 72 10 	movl   $0x80107295,0x4(%esp)
801035fd:	80 
...
80103668:	eb ea                	jmp    80103654 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010366a:	c7 04 24 9c 72 10 80 	movl   $0x8010729c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103676:	c7 04 24 78 73 10 80 	movl   $0x80107378,(%esp)
...
801036f3:	e8 a8 33 00 00       	call   80106aa0 <setupkvm>
...
80103715:	80 
80103716:	e8 b5 30 00 00       	call   801067d0 <inituvm>
  p->sz = PGSIZE;
...
80103792:	00 
80103793:	c7 44 24 04 c5 72 10 	movl   $0x801072c5,0x4(%esp)
8010379a:	80 
8010379b:	89 04 24             	mov    %eax,(%esp)
8010379e:	e8 fd 0d 00 00       	call   801045a0 <safestrcpy>
  p->cwd = namei("/");
801037a3:	c7 04 24 ce 72 10 80 	movl   $0x801072ce,(%esp)
801037aa:	e8 51 e7 ff ff       	call   80101f00 <namei>
...
801037d6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037d7:	c7 04 24 ac 72 10 80 	movl   $0x801072ac,(%esp)
...
80103819:	e8 f2 30 00 00       	call   80106910 <allocuvm>
...
80103827:	e8 94 2e 00 00       	call   801066c0 <switchuvm>
  return 0;
...
8010384a:	e8 b1 31 00 00       	call   80106a00 <deallocuvm>
...
8010388e:	e8 ed 32 00 00       	call   80106b80 <copyuvm>
...
801038f0:	e8 8b dd ff ff       	call   80101680 <idup>
...
8010394e:	e8 9d e9 ff ff       	call   801022f0 <kfree>
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
...
80103979:	e8 92 fc ff ff       	call   80103610 <mycpu>
  c->proc = 0;
8010397e:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103985:	00 00 00 
scheduler(void)
{
  struct proc *p;
...
8010398a:	8d 40 04             	lea    0x4(%eax),%eax
...
80103991:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103998:	be 54 2d 11 80       	mov    $0x80112d54,%esi
  for(;;){
    // Enable interrupts on this processor.
    sti();
 struct proc *highP;
...
801039a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039a8:	81 c6 14 02 00 00    	add    $0x214,%esi
801039ae:	81 fe 54 b2 11 80    	cmp    $0x8011b254,%esi
801039b4:	74 7f                	je     80103a35 <scheduler+0xc5>
      
      if(p->state != RUNNABLE)
801039b6:	83 7e 0c 03          	cmpl   $0x3,0xc(%esi)
801039ba:	75 ec                	jne    801039a8 <scheduler+0x38>
801039bc:	89 f7                	mov    %esi,%edi
801039be:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
801039c3:	90                   	nop
801039c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801039c8:	8b 82 10 02 00 00    	mov    0x210(%edx),%eax
801039ce:	39 87 10 02 00 00    	cmp    %eax,0x210(%edi)
801039d4:	0f 4f fa             	cmovg  %edx,%edi
        continue;
...
801039d7:	81 c2 14 02 00 00    	add    $0x214,%edx
801039dd:	81 fa 54 b2 11 80    	cmp    $0x8011b254,%edx
801039e3:	75 e3                	jne    801039c8 <scheduler+0x58>
    }  
      ...
      c->proc = highP;
801039e5:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039eb:	81 c6 14 02 00 00    	add    $0x214,%esi
      ...
      c->proc = highP;
      switchuvm(highP);
801039f1:	89 3c 24             	mov    %edi,(%esp)
801039f4:	e8 c7 2c 00 00       	call   801066c0 <switchuvm>
      highP->state = RUNNING;

      swtch(&(c->scheduler), highP->context);
801039f9:	8b 57 1c             	mov    0x1c(%edi),%edx
801039fc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
      // Switch to chosen process.  It is the process's job
      // to release ptable.lock and then reacquire it
      // before jumping back to us.
      c->proc = highP;
      switchuvm(highP);
      highP->state = RUNNING;
801039ff:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)

      swtch(&(c->scheduler), highP->context);
80103a06:	89 54 24 04          	mov    %edx,0x4(%esp)
80103a0a:	89 04 24             	mov    %eax,(%esp)
80103a0d:	e8 e9 0b 00 00       	call   801045fb <swtch>
      switchkvm();
80103a12:	e8 89 2c 00 00       	call   801066a0 <switchkvm>
      highP->calculatedPriority+=highP->priority;
80103a17:	8b 97 0c 02 00 00    	mov    0x20c(%edi),%edx
80103a1d:	01 97 10 02 00 00    	add    %edx,0x210(%edi)
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a23:	81 fe 54 b2 11 80    	cmp    $0x8011b254,%esi
      switchkvm();
      highP->calculatedPriority+=highP->priority;
      ...
      c->proc = 0;
80103a29:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a30:	00 00 00 
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a33:	75 81                	jne    801039b6 <scheduler+0x46>
    ...
    release(&ptable.lock);
80103a35:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a3c:	e8 2f 09 00 00       	call   80104370 <release>

  }
80103a41:	e9 4a ff ff ff       	jmp    80103990 <scheduler+0x20>
...
80103a58:	e8 53 fc ff ff       	call   801036b0 <myproc>
...
80103a64:	89 c3                	mov    %eax,%ebx
  ...
  if(!holding(&ptable.lock))
80103a66:	e8 55 08 00 00       	call   801042c0 <holding>
80103a6b:	85 c0                	test   %eax,%eax
80103a6d:	74 4f                	je     80103abe <sched+0x6e>
    panic("sched ptable.lock");
  if(mycpu()->ncli != 1)
80103a6f:	e8 9c fb ff ff       	call   80103610 <mycpu>
...
80103a88:	75 40                	jne    80103aca <sched+0x7a>
  ...
  intena = mycpu()->intena;
80103a8a:	e8 81 fb ff ff       	call   80103610 <mycpu>
...
80103a92:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103a98:	e8 73 fb ff ff       	call   80103610 <mycpu>
80103a9d:	8b 40 04             	mov    0x4(%eax),%eax
80103aa0:	89 1c 24             	mov    %ebx,(%esp)
80103aa3:	89 44 24 04          	mov    %eax,0x4(%esp)
80103aa7:	e8 4f 0b 00 00       	call   801045fb <swtch>
  mycpu()->intena = intena;
80103aac:	e8 5f fb ff ff       	call   80103610 <mycpu>
...
80103abd:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103abe:	c7 04 24 d0 72 10 80 	movl   $0x801072d0,(%esp)
80103ac5:	e8 96 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103aca:	c7 04 24 fc 72 10 80 	movl   $0x801072fc,(%esp)
80103ad1:	e8 8a c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103ad6:	c7 04 24 ee 72 10 80 	movl   $0x801072ee,(%esp)
80103add:	e8 7e c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103ae2:	c7 04 24 e2 72 10 80 	movl   $0x801072e2,(%esp)
...
80103af7:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103afa:	e8 b1 fb ff ff       	call   801036b0 <myproc>
  struct proc *p;
  int fd;
...
80103b05:	89 c3                	mov    %eax,%ebx
  ...
  if(curproc == initproc)
80103b07:	0f 84 fd 00 00 00    	je     80103c0a <exit+0x11a>
...
80103b60:	eb 14                	jmp    80103b76 <exit+0x86>
80103b62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103b68:	81 c2 14 02 00 00    	add    $0x214,%edx
80103b6e:	81 fa 54 b2 11 80    	cmp    $0x8011b254,%edx
80103b74:	74 20                	je     80103b96 <exit+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80103b76:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103b7a:	75 ec                	jne    80103b68 <exit+0x78>
80103b7c:	3b 42 20             	cmp    0x20(%edx),%eax
80103b7f:	75 e7                	jne    80103b68 <exit+0x78>
      p->state = RUNNABLE;
80103b81:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103b88:	81 c2 14 02 00 00    	add    $0x214,%edx
80103b8e:	81 fa 54 b2 11 80    	cmp    $0x8011b254,%edx
80103b94:	75 e0                	jne    80103b76 <exit+0x86>
  wakeup1(curproc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103b96:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
80103b9b:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80103ba0:	eb 14                	jmp    80103bb6 <exit+0xc6>
80103ba2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ba8:	81 c1 14 02 00 00    	add    $0x214,%ecx
80103bae:	81 f9 54 b2 11 80    	cmp    $0x8011b254,%ecx
80103bb4:	74 3c                	je     80103bf2 <exit+0x102>
    if(p->parent == curproc){
80103bb6:	39 59 14             	cmp    %ebx,0x14(%ecx)
80103bb9:	75 ed                	jne    80103ba8 <exit+0xb8>
      p->parent = initproc;
      if(p->state == ZOMBIE)
80103bbb:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
  wakeup1(curproc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103bbf:	89 41 14             	mov    %eax,0x14(%ecx)
      if(p->state == ZOMBIE)
80103bc2:	75 e4                	jne    80103ba8 <exit+0xb8>
80103bc4:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103bc9:	eb 13                	jmp    80103bde <exit+0xee>
80103bcb:	90                   	nop
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103bd0:	81 c2 14 02 00 00    	add    $0x214,%edx
80103bd6:	81 fa 54 b2 11 80    	cmp    $0x8011b254,%edx
80103bdc:	74 ca                	je     80103ba8 <exit+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
80103bde:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103be2:	75 ec                	jne    80103bd0 <exit+0xe0>
80103be4:	3b 42 20             	cmp    0x20(%edx),%eax
80103be7:	75 e7                	jne    80103bd0 <exit+0xe0>
      p->state = RUNNABLE;
80103be9:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
80103bf0:	eb de                	jmp    80103bd0 <exit+0xe0>
        wakeup1(initproc);
    }
  }
...
80103bf2:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103bf9:	e8 52 fe ff ff       	call   80103a50 <sched>
  panic("zombie exit");
80103bfe:	c7 04 24 1d 73 10 80 	movl   $0x8010731d,(%esp)
80103c05:	e8 56 c7 ff ff       	call   80100360 <panic>
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
  ...
  if(curproc == initproc)
    panic("init exiting");
80103c0a:	c7 04 24 10 73 10 80 	movl   $0x80107310,(%esp)
80103c11:	e8 4a c7 ff ff       	call   80100360 <panic>
...
80103c2d:	e8 ce 06 00 00       	call   80104300 <acquire>
  myproc()->state = RUNNABLE;
80103c32:	e8 79 fa ff ff       	call   801036b0 <myproc>
80103c37:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80103c3e:	e8 0d fe ff ff       	call   80103a50 <sched>
  release(&ptable.lock);
80103c43:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c4a:	e8 21 07 00 00       	call   80104370 <release>
}
80103c4f:	c9                   	leave  
80103c50:	c3                   	ret    
...
80103c6c:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103c6f:	e8 3c fa ff ff       	call   801036b0 <myproc>
...
80103c91:	e8 6a 06 00 00       	call   80104300 <acquire>
    release(lk);
80103c96:	89 34 24             	mov    %esi,(%esp)
80103c99:	e8 d2 06 00 00       	call   80104370 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103ca1:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  ...
  sched();
80103ca8:	e8 a3 fd ff ff       	call   80103a50 <sched>
...
80103cbb:	e8 b0 06 00 00       	call   80104370 <release>
    acquire(lk);
...
80103cc9:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103cca:	e9 31 06 00 00       	jmp    80104300 <acquire>
80103ccf:	90                   	nop
  if(lk != &ptable.lock){  //DOC: sleeplock0
    acquire(&ptable.lock);  //DOC: sleeplock1
    release(lk);
...
80103cd3:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  ...
  sched();
80103cda:	e8 71 fd ff ff       	call   80103a50 <sched>
...
80103cee:	c7 04 24 2f 73 10 80 	movl   $0x8010732f,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103cfa:	c7 04 24 29 73 10 80 	movl   $0x80107329,(%esp)
...
80103d15:	83 ec 10             	sub    $0x10,%esp
  ...
  int havekids, pid;
  struct proc *curproc = myproc();
80103d18:	e8 93 f9 ff ff       	call   801036b0 <myproc>
...
80103d24:	89 c6                	mov    %eax,%esi
  ...
  acquire(&ptable.lock);
80103d26:	e8 d5 05 00 00       	call   80104300 <acquire>
  for(;;){
...
80103d32:	eb 12                	jmp    80103d46 <wait+0x36>
80103d34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d38:	81 c3 14 02 00 00    	add    $0x214,%ebx
80103d3e:	81 fb 54 b2 11 80    	cmp    $0x8011b254,%ebx
80103d44:	74 22                	je     80103d68 <wait+0x58>
      if(p->parent != curproc)
80103d46:	39 73 14             	cmp    %esi,0x14(%ebx)
80103d49:	75 ed                	jne    80103d38 <wait+0x28>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103d4b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103d4f:	74 34                	je     80103d85 <wait+0x75>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d51:	81 c3 14 02 00 00    	add    $0x214,%ebx
      if(p->parent != curproc)
        continue;
      havekids = 1;
80103d57:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d5c:	81 fb 54 b2 11 80    	cmp    $0x8011b254,%ebx
80103d62:	75 e2                	jne    80103d46 <wait+0x36>
...
80103d6a:	74 6e                	je     80103dda <wait+0xca>
80103d6c:	8b 46 24             	mov    0x24(%esi),%eax
80103d6f:	85 c0                	test   %eax,%eax
80103d71:	75 67                	jne    80103dda <wait+0xca>
      release(&ptable.lock);
      return -1;
    }
...
80103d73:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103d7a:	80 
80103d7b:	89 34 24             	mov    %esi,(%esp)
80103d7e:	e8 dd fe ff ff       	call   80103c60 <sleep>
  }
80103d83:	eb a6                	jmp    80103d2b <wait+0x1b>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
80103d85:	8b 43 08             	mov    0x8(%ebx),%eax
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
80103d88:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103d8b:	89 04 24             	mov    %eax,(%esp)
80103d8e:	e8 5d e5 ff ff       	call   801022f0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103d93:	8b 43 04             	mov    0x4(%ebx),%eax
      ...
      if(p->state == ZOMBIE){
        ...
        kfree(p->kstack);
        p->kstack = 0;
80103d96:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103d9d:	89 04 24             	mov    %eax,(%esp)
80103da0:	e8 7b 2c 00 00       	call   80106a20 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
80103da5:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
        freevm(p->pgdir);
        p->pid = 0;
80103dac:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103db3:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103dba:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103dbe:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103dc5:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103dcc:	e8 9f 05 00 00       	call   80104370 <release>
    }
...
80103de1:	e8 8a 05 00 00       	call   80104370 <release>
    }
...
80103e11:	e8 ea 04 00 00       	call   80104300 <acquire>
static void
wakeup1(void *chan)
{
  struct proc *p;
...
80103e1b:	eb 0f                	jmp    80103e2c <wakeup+0x2c>
80103e1d:	8d 76 00             	lea    0x0(%esi),%esi
80103e20:	05 14 02 00 00       	add    $0x214,%eax
80103e25:	3d 54 b2 11 80       	cmp    $0x8011b254,%eax
80103e2a:	74 24                	je     80103e50 <wakeup+0x50>
    if(p->state == SLEEPING && p->chan == chan)
80103e2c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103e30:	75 ee                	jne    80103e20 <wakeup+0x20>
80103e32:	3b 58 20             	cmp    0x20(%eax),%ebx
80103e35:	75 e9                	jne    80103e20 <wakeup+0x20>
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e3e:	05 14 02 00 00       	add    $0x214,%eax
80103e43:	3d 54 b2 11 80       	cmp    $0x8011b254,%eax
80103e48:	75 e2                	jne    80103e2c <wakeup+0x2c>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103e50:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103e57:	83 c4 14             	add    $0x14,%esp
80103e5a:	5b                   	pop    %ebx
80103e5b:	5d                   	pop    %ebp
void
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103e5c:	e9 0f 05 00 00       	jmp    80104370 <release>
80103e61:	eb 0d                	jmp    80103e70 <kill>
80103e63:	90                   	nop
80103e64:	90                   	nop
80103e65:	90                   	nop
80103e66:	90                   	nop
...
80103e81:	e8 7a 04 00 00       	call   80104300 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e86:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e8b:	eb 0f                	jmp    80103e9c <kill+0x2c>
80103e8d:	8d 76 00             	lea    0x0(%esi),%esi
80103e90:	05 14 02 00 00       	add    $0x214,%eax
80103e95:	3d 54 b2 11 80       	cmp    $0x8011b254,%eax
80103e9a:	74 3c                	je     80103ed8 <kill+0x68>
    if(p->pid == pid){
80103e9c:	39 58 10             	cmp    %ebx,0x10(%eax)
80103e9f:	75 ef                	jne    80103e90 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103ea1:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
      p->killed = 1;
80103ea5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103eac:	74 1a                	je     80103ec8 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
80103eae:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103eb5:	e8 b6 04 00 00       	call   80104370 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103eba:	83 c4 14             	add    $0x14,%esp
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
...
80103ec2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
      ...
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
80103ec8:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103ecf:	eb dd                	jmp    80103eae <kill+0x3e>
80103ed1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&ptable.lock);
80103ed8:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103edf:	e8 8c 04 00 00       	call   80104370 <release>
  return -1;
}
80103ee4:	83 c4 14             	add    $0x14,%esp
      release(&ptable.lock);
      return 0;
    }
  }
...
80103ef6:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
80103efb:	83 ec 4c             	sub    $0x4c,%esp
80103efe:	8d 75 e8             	lea    -0x18(%ebp),%esi
80103f01:	eb 23                	jmp    80103f26 <procdump+0x36>
80103f03:	90                   	nop
80103f04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f08:	c7 04 24 d7 76 10 80 	movl   $0x801076d7,(%esp)
80103f0f:	e8 3c c7 ff ff       	call   80100650 <cprintf>
80103f14:	81 c3 14 02 00 00    	add    $0x214,%ebx
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f1a:	81 fb c0 b2 11 80    	cmp    $0x8011b2c0,%ebx
80103f20:	0f 84 8a 00 00 00    	je     80103fb0 <procdump+0xc0>
    if(p->state == UNUSED)
80103f26:	8b 43 a0             	mov    -0x60(%ebx),%eax
80103f29:	85 c0                	test   %eax,%eax
80103f2b:	74 e7                	je     80103f14 <procdump+0x24>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f2d:	83 f8 05             	cmp    $0x5,%eax
      state = states[p->state];
    else
      state = "???";
80103f30:	ba 40 73 10 80       	mov    $0x80107340,%edx
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f35:	77 11                	ja     80103f48 <procdump+0x58>
80103f37:	8b 14 85 a0 73 10 80 	mov    -0x7fef8c60(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103f3e:	b8 40 73 10 80       	mov    $0x80107340,%eax
80103f43:	85 d2                	test   %edx,%edx
80103f45:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80103f48:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80103f4b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80103f4f:	89 54 24 08          	mov    %edx,0x8(%esp)
80103f53:	c7 04 24 44 73 10 80 	movl   $0x80107344,(%esp)
80103f5a:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f5e:	e8 ed c6 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
80103f63:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80103f67:	75 9f                	jne    80103f08 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80103f69:	8d 45 c0             	lea    -0x40(%ebp),%eax
80103f6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f70:	8b 43 b0             	mov    -0x50(%ebx),%eax
80103f73:	8d 7d c0             	lea    -0x40(%ebp),%edi
80103f76:	8b 40 0c             	mov    0xc(%eax),%eax
80103f79:	83 c0 08             	add    $0x8,%eax
80103f7c:	89 04 24             	mov    %eax,(%esp)
80103f7f:	e8 2c 02 00 00       	call   801041b0 <getcallerpcs>
...
80103f99:	c7 04 24 81 6d 10 80 	movl   $0x80106d81,(%esp)
...
80103fc7:	83 ec 10             	sub    $0x10,%esp
80103fca:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;
  int childrens=0;

acquire(&ptable.lock);
80103fcd:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103fd4:	e8 27 03 00 00       	call   80104300 <acquire>

    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fd9:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103fde:	eb 0e                	jmp    80103fee <getChildren+0x2e>
80103fe0:	81 c2 14 02 00 00    	add    $0x214,%edx
80103fe6:	81 fa 54 b2 11 80    	cmp    $0x8011b254,%edx
80103fec:	74 21                	je     8010400f <getChildren+0x4f>
      if(p->parent->pid==procId){
80103fee:	8b 4a 14             	mov    0x14(%edx),%ecx
80103ff1:	39 59 10             	cmp    %ebx,0x10(%ecx)
80103ff4:	75 ea                	jne    80103fe0 <getChildren+0x20>
        childrens=(childrens*10)+(p->pid*10);
80103ff6:	8b 42 10             	mov    0x10(%edx),%eax
  struct proc *p;
  int childrens=0;
...
acquire(&ptable.lock);
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ff9:	81 c2 14 02 00 00    	add    $0x214,%edx
      if(p->parent->pid==procId){
        childrens=(childrens*10)+(p->pid*10);
80103fff:	01 f0                	add    %esi,%eax
  struct proc *p;
  int childrens=0;
...
acquire(&ptable.lock);
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104001:	81 fa 54 b2 11 80    	cmp    $0x8011b254,%edx
      if(p->parent->pid==procId){
        childrens=(childrens*10)+(p->pid*10);
80104007:	8d 04 80             	lea    (%eax,%eax,4),%eax
8010400a:	8d 34 00             	lea    (%eax,%eax,1),%esi
  struct proc *p;
  int childrens=0;
...
acquire(&ptable.lock);
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010400d:	75 df                	jne    80103fee <getChildren+0x2e>
      if(p->parent->pid==procId){
        childrens=(childrens*10)+(p->pid*10);
      }
    }
      release(&ptable.lock);
8010400f:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104016:	e8 55 03 00 00       	call   80104370 <release>
...
80104022:	5d                   	pop    %ebp
80104023:	c3                   	ret    
80104024:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010402a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80104033:	83 ec 18             	sub    $0x18,%esp
  argint(0,&sysNum);
80104036:	8d 45 08             	lea    0x8(%ebp),%eax
80104039:	89 44 24 04          	mov    %eax,0x4(%esp)
8010403d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104044:	e8 67 06 00 00       	call   801046b0 <argint>
 
  return myproc()->arraySys[sysNum];
80104049:	e8 62 f6 ff ff       	call   801036b0 <myproc>
8010404e:	8b 55 08             	mov    0x8(%ebp),%edx
80104051:	8b 44 90 7c          	mov    0x7c(%eax,%edx,4),%eax
...
8010406a:	c7 44 24 04 b8 73 10 	movl   $0x801073b8,0x4(%esp)
80104071:	80 
...
801040c7:	e8 94 fb ff ff       	call   80103c60 <sleep>
...
80104126:	e8 d5 fc ff ff       	call   80103e00 <wakeup>
  release(&lk->lk);
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010429a:	c7 04 24 da 73 10 80 	movl   $0x801073da,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
801042a6:	c7 04 24 c3 73 10 80 	movl   $0x801073c3,(%esp)
...
80104319:	75 3c                	jne    80104357 <acquire+0x57>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104334:	e8 d7 f2 ff ff       	call   80103610 <mycpu>
80104339:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010433c:	8b 45 08             	mov    0x8(%ebp),%eax
8010433f:	83 c0 0c             	add    $0xc,%eax
80104342:	89 44 24 04          	mov    %eax,0x4(%esp)
80104346:	8d 45 08             	lea    0x8(%ebp),%eax
80104349:	89 04 24             	mov    %eax,(%esp)
8010434c:	e8 5f fe ff ff       	call   801041b0 <getcallerpcs>
}
80104351:	83 c4 14             	add    $0x14,%esp
80104354:	5b                   	pop    %ebx
80104355:	5d                   	pop    %ebp
80104356:	c3                   	ret    
void
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
80104357:	c7 04 24 e1 73 10 80 	movl   $0x801073e1,(%esp)
8010435e:	e8 fd bf ff ff       	call   80100360 <panic>
...
80104384:	74 23                	je     801043a9 <release+0x39>
    panic("release");
...
80104399:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
...
801043a3:	5d                   	pop    %ebp
  ...
  popcli();
801043a4:	e9 a7 fe ff ff       	jmp    80104250 <popcli>
// Release the lock.
void
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
801043a9:	c7 04 24 e9 73 10 80 	movl   $0x801073e9,(%esp)
...
{
  return memmove(dst, src, n);
801044d4:	e9 87 ff ff ff       	jmp    80104460 <memmove>
...
80104786:	83 ec 1c             	sub    $0x1c,%esp
  int num;
  struct proc *curproc = myproc();
80104789:	e8 22 ef ff ff       	call   801036b0 <myproc>

  num = curproc->tf->eax;
8010478e:	8b 78 18             	mov    0x18(%eax),%edi
...
80104791:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104793:	8b 77 1c             	mov    0x1c(%edi),%esi

  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104796:	8d 46 ff             	lea    -0x1(%esi),%eax
80104799:	83 f8 17             	cmp    $0x17,%eax
8010479c:	77 22                	ja     801047c0 <syscall+0x40>
8010479e:	8b 04 b5 20 74 10 80 	mov    -0x7fef8be0(,%esi,4),%eax
801047a5:	85 c0                	test   %eax,%eax
801047a7:	74 17                	je     801047c0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
801047a9:	ff d0                	call   *%eax
801047ab:	89 47 1c             	mov    %eax,0x1c(%edi)
    curproc->arraySys[num]++;
801047ae:	83 44 b3 7c 01       	addl   $0x1,0x7c(%ebx,%esi,4)
  } else {
...
801047b3:	83 c4 1c             	add    $0x1c,%esp
801047b6:	5b                   	pop    %ebx
801047b7:	5e                   	pop    %esi
801047b8:	5f                   	pop    %edi
801047b9:	5d                   	pop    %ebp
...
801047bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
801047c0:	8d 43 6c             	lea    0x6c(%ebx),%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801047c3:	89 74 24 0c          	mov    %esi,0xc(%esp)
            curproc->pid, curproc->name, num);
801047c7:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801047cb:	8b 43 10             	mov    0x10(%ebx),%eax
801047ce:	c7 04 24 f1 73 10 80 	movl   $0x801073f1,(%esp)
801047d5:	89 44 24 04          	mov    %eax,0x4(%esp)
801047d9:	e8 72 be ff ff       	call   80100650 <cprintf>
            curproc->pid, curproc->name, num);
    curproc->tf->eax = -1;
801047de:	8b 43 18             	mov    0x18(%ebx),%eax
801047e1:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
801047e8:	83 c4 1c             	add    $0x1c,%esp
801047eb:	5b                   	pop    %ebx
801047ec:	5e                   	pop    %esi
801047ed:	5f                   	pop    %edi
801047ee:	5d                   	pop    %ebp
...
80104950:	c7 44 24 04 a0 74 10 	movl   $0x801074a0,0x4(%esp)
80104957:	80 
...
8010496b:	c7 44 24 04 9f 74 10 	movl   $0x8010749f,0x4(%esp)
80104972:	80 
...
80104981:	79 89                	jns    8010490c <create+0xdc>
      panic("create dots");
80104983:	c7 04 24 93 74 10 80 	movl   $0x80107493,(%esp)
8010498a:	e8 d1 b9 ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010498f:	c7 04 24 a2 74 10 80 	movl   $0x801074a2,(%esp)
80104996:	e8 c5 b9 ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010499b:	c7 04 24 84 74 10 80 	movl   $0x80107484,(%esp)
...
80104d41:	c7 44 24 04 a0 74 10 	movl   $0x801074a0,0x4(%esp)
80104d48:	80 
...
80104d59:	c7 44 24 04 9f 74 10 	movl   $0x8010749f,0x4(%esp)
80104d60:	80 
...
80104ea8:	e9 48 ff ff ff       	jmp    80104df5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104ead:	c7 04 24 c4 74 10 80 	movl   $0x801074c4,(%esp)
80104eb4:	e8 a7 b4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104eb9:	c7 04 24 d6 74 10 80 	movl   $0x801074d6,(%esp)
80104ec0:	e8 9b b4 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104ec5:	c7 04 24 b2 74 10 80 	movl   $0x801074b2,(%esp)
...
80105343:	83 ec 08             	sub    $0x8,%esp
  exit();
80105346:	e8 a5 e7 ff ff       	call   80103af0 <exit>
...
{
  return wait();
80105354:	e9 b7 e9 ff ff       	jmp    80103d10 <wait>
...
80105374:	e8 37 f3 ff ff       	call   801046b0 <argint>
80105379:	85 c0                	test   %eax,%eax
8010537b:	78 13                	js     80105390 <sys_kill+0x30>
    return -1;
  return kill(pid);
8010537d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105380:	89 04 24             	mov    %eax,(%esp)
80105383:	e8 e8 ea ff ff       	call   80103e70 <kill>
}
80105388:	c9                   	leave  
80105389:	c3                   	ret    
...
801053a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801053a6:	e8 05 e3 ff ff       	call   801036b0 <myproc>
...
801053c5:	e8 e6 f2 ff ff       	call   801046b0 <argint>
801053ca:	85 c0                	test   %eax,%eax
801053cc:	78 22                	js     801053f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801053ce:	e8 dd e2 ff ff       	call   801036b0 <myproc>
  if(growproc(n) < 0)
801053d3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  int addr;
  int n;
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
801053d6:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801053d8:	89 14 24             	mov    %edx,(%esp)
801053db:	e8 10 e4 ff ff       	call   801037f0 <growproc>
801053e0:	85 c0                	test   %eax,%eax
801053e2:	78 0c                	js     801053f0 <sys_sbrk+0x40>
    return -1;
  return addr;
...
801053f5:	eb ef                	jmp    801053e6 <sys_sbrk+0x36>
...
80105415:	e8 96 f2 ff ff       	call   801046b0 <argint>
8010541a:	85 c0                	test   %eax,%eax
8010541c:	78 7e                	js     8010549c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010541e:	c7 04 24 60 b2 11 80 	movl   $0x8011b260,(%esp)
80105425:	e8 d6 ee ff ff       	call   80104300 <acquire>
  ticks0 = ticks;
...
8010542a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010542d:	8b 1d a0 ba 11 80    	mov    0x8011baa0,%ebx
  while(ticks - ticks0 < n){
80105433:	85 d2                	test   %edx,%edx
80105435:	75 29                	jne    80105460 <sys_sleep+0x60>
80105437:	eb 4f                	jmp    80105488 <sys_sleep+0x88>
...
80105440:	c7 44 24 04 60 b2 11 	movl   $0x8011b260,0x4(%esp)
80105447:	80 
80105448:	c7 04 24 a0 ba 11 80 	movl   $0x8011baa0,(%esp)
8010544f:	e8 0c e8 ff ff       	call   80103c60 <sleep>
...
80105484:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105488:	c7 04 24 60 b2 11 80 	movl   $0x8011b260,(%esp)
8010548f:	e8 dc ee ff ff       	call   80104370 <release>
  return 0;
}
...
801054a1:	eb da                	jmp    8010547d <sys_sleep+0x7d>
...
801054b4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801054b7:	c7 04 24 60 b2 11 80 	movl   $0x8011b260,(%esp)
801054be:	e8 3d ee ff ff       	call   80104300 <acquire>
  xticks = ticks;
801054c3:	8b 1d a0 ba 11 80    	mov    0x8011baa0,%ebx
  release(&tickslock);
801054c9:	c7 04 24 60 b2 11 80 	movl   $0x8011b260,(%esp)
801054d0:	e8 9b ee ff ff       	call   80104370 <release>
  return xticks;
}
...
801054e6:	c7 04 24 e5 74 10 80 	movl   $0x801074e5,(%esp)
801054ed:	e8 5e b1 ff ff       	call   80100650 <cprintf>
    struct proc *curproc = myproc();
801054f2:	e8 b9 e1 ff ff       	call   801036b0 <myproc>
    return curproc->parent->pid;
801054f7:	8b 40 14             	mov    0x14(%eax),%eax
801054fa:	8b 40 10             	mov    0x10(%eax),%eax
}
801054fd:	c9                   	leave  
801054fe:	c3                   	ret    
801054ff:	90                   	nop

80105500 <sys_getChildren>:
int
...
{
  return getChildren(procId);
80105504:	e9 b7 ea ff ff       	jmp    80103fc0 <getChildren>
80105509:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105510 <sys_getCount>:
}
int
...
sys_getCount(int sysNum){
  return getCount(sysNum);
80105514:	e9 17 eb ff ff       	jmp    80104030 <getCount>
...
8010551a:	06                   	push   %es
  pushl %fs
8010551b:	0f a0                	push   %fs
  pushl %gs
8010551d:	0f a8                	push   %gs
  pushal
8010551f:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105520:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105524:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105526:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105528:	54                   	push   %esp
  call trap
80105529:	e8 e2 00 00 00       	call   80105610 <trap>
  addl $4, %esp
8010552e:	83 c4 04             	add    $0x4,%esp
...
80105531:	61                   	popa   
  popl %gs
80105532:	0f a9                	pop    %gs
  popl %fs
80105534:	0f a1                	pop    %fs
  popl %es
80105536:	07                   	pop    %es
  popl %ds
80105537:	1f                   	pop    %ds
...
80105554:	66 89 0c c5 a2 b2 11 	mov    %cx,-0x7fee4d5e(,%eax,8)
8010555b:	80 
8010555c:	c6 04 c5 a4 b2 11 80 	movb   $0x0,-0x7fee4d5c(,%eax,8)
80105563:	00 
80105564:	c6 04 c5 a5 b2 11 80 	movb   $0x8e,-0x7fee4d5b(,%eax,8)
8010556b:	8e 
8010556c:	66 89 14 c5 a0 b2 11 	mov    %dx,-0x7fee4d60(,%eax,8)
80105573:	80 
80105574:	c1 ea 10             	shr    $0x10,%edx
80105577:	66 89 14 c5 a6 b2 11 	mov    %dx,-0x7fee4d5a(,%eax,8)
8010557e:	80 
void
tvinit(void)
{
...
80105599:	c7 44 24 04 f7 74 10 	movl   $0x801074f7,0x4(%esp)
801055a0:	80 
801055a1:	c7 04 24 60 b2 11 80 	movl   $0x8011b260,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801055a8:	66 89 15 a2 b4 11 80 	mov    %dx,0x8011b4a2
801055af:	66 a3 a0 b4 11 80    	mov    %ax,0x8011b4a0
801055b5:	c1 e8 10             	shr    $0x10,%eax
801055b8:	c6 05 a4 b4 11 80 00 	movb   $0x0,0x8011b4a4
801055bf:	c6 05 a5 b4 11 80 ef 	movb   $0xef,0x8011b4a5
801055c6:	66 a3 a6 b4 11 80    	mov    %ax,0x8011b4a6

  initlock(&tickslock, "time");
801055cc:	e8 bf eb ff ff       	call   80104190 <initlock>
}
801055d1:	c9                   	leave  
801055d2:	c3                   	ret    
...
801055eb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801055ef:	b8 a0 b2 11 80       	mov    $0x8011b2a0,%eax
...
80105630:	ff 24 85 a0 75 10 80 	jmp    *-0x7fef8a60(,%eax,4)
80105637:	90                   	nop
    lapiceoi();
    break;
...
80105638:	e8 73 e0 ff ff       	call   801036b0 <myproc>
...
8010565c:	e8 2f e0 ff ff       	call   80103690 <cpuid>
...
80105674:	e8 37 e0 ff ff       	call   801036b0 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
801056a3:	c7 04 24 5c 75 10 80 	movl   $0x8010755c,(%esp)
801056aa:	89 44 24 04          	mov    %eax,0x4(%esp)
801056ae:	e8 9d af ff ff       	call   80100650 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801056b3:	e8 f8 df ff ff       	call   801036b0 <myproc>
...
801056c0:	e8 eb df ff ff       	call   801036b0 <myproc>
801056c5:	85 c0                	test   %eax,%eax
801056c7:	74 0c                	je     801056d5 <trap+0xc5>
801056c9:	e8 e2 df ff ff       	call   801036b0 <myproc>
...
801056d5:	e8 d6 df ff ff       	call   801036b0 <myproc>
801056da:	85 c0                	test   %eax,%eax
801056dc:	74 0d                	je     801056eb <trap+0xdb>
801056de:	66 90                	xchg   %ax,%ax
801056e0:	e8 cb df ff ff       	call   801036b0 <myproc>
...
801056e9:	74 4d                	je     80105738 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801056eb:	e8 c0 df ff ff       	call   801036b0 <myproc>
801056f0:	85 c0                	test   %eax,%eax
801056f2:	74 1d                	je     80105711 <trap+0x101>
801056f4:	e8 b7 df ff ff       	call   801036b0 <myproc>
...
8010572b:	75 a8                	jne    801056d5 <trap+0xc5>
    exit();
8010572d:	e8 be e3 ff ff       	call   80103af0 <exit>
...
80105740:	75 a9                	jne    801056eb <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105742:	e8 d9 e4 ff ff       	call   80103c20 <yield>
...
80105749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105750:	e8 3b df ff ff       	call   80103690 <cpuid>
...
8010575d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105760:	e8 1b d0 ff ff       	call   80102780 <lapiceoi>
    break;
...
8010576a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105770:	e8 5b ce ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105775:	e8 06 d0 ff ff       	call   80102780 <lapiceoi>
    break;
8010577a:	e9 41 ff ff ff       	jmp    801056c0 <trap+0xb0>
8010577f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105780:	e8 1b 02 00 00       	call   801059a0 <uartintr>
    lapiceoi();
80105785:	e8 f6 cf ff ff       	call   80102780 <lapiceoi>
    break;
...
80105797:	e8 f4 de ff ff       	call   80103690 <cpuid>
8010579c:	c7 04 24 04 75 10 80 	movl   $0x80107504,(%esp)
801057a3:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801057a7:	89 74 24 08          	mov    %esi,0x8(%esp)
801057ab:	89 44 24 04          	mov    %eax,0x4(%esp)
801057af:	e8 9c ae ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801057b4:	e8 c7 cf ff ff       	call   80102780 <lapiceoi>
    break;
...
801057be:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801057c0:	e8 bb c8 ff ff       	call   80102080 <ideintr>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
801057d0:	e8 db de ff ff       	call   801036b0 <myproc>
801057d5:	8b 70 24             	mov    0x24(%eax),%esi
801057d8:	85 f6                	test   %esi,%esi
801057da:	75 2c                	jne    80105808 <trap+0x1f8>
      exit();
    myproc()->tf = tf;
801057dc:	e8 cf de ff ff       	call   801036b0 <myproc>
801057e1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801057e4:	e8 97 ef ff ff       	call   80104780 <syscall>
    if(myproc()->killed)
...
801057ff:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105800:	e9 eb e2 ff ff       	jmp    80103af0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105808:	e8 e3 e2 ff ff       	call   80103af0 <exit>
...
8010580f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
80105810:	c7 04 24 60 b2 11 80 	movl   $0x8011b260,(%esp)
80105817:	e8 e4 ea ff ff       	call   80104300 <acquire>
      ticks++;
      wakeup(&ticks);
8010581c:	c7 04 24 a0 ba 11 80 	movl   $0x8011baa0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105823:	83 05 a0 ba 11 80 01 	addl   $0x1,0x8011baa0
      wakeup(&ticks);
8010582a:	e8 d1 e5 ff ff       	call   80103e00 <wakeup>
      release(&tickslock);
8010582f:	c7 04 24 60 b2 11 80 	movl   $0x8011b260,(%esp)
80105836:	e8 35 eb ff ff       	call   80104370 <release>
...
80105846:	e8 45 de ff ff       	call   80103690 <cpuid>
...
8010585a:	c7 04 24 28 75 10 80 	movl   $0x80107528,(%esp)
80105861:	89 44 24 04          	mov    %eax,0x4(%esp)
80105865:	e8 e6 ad ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010586a:	c7 04 24 fc 74 10 80 	movl   $0x801074fc,(%esp)
...
80105901:	31 c9                	xor    %ecx,%ecx
80105903:	89 e5                	mov    %esp,%ebp
80105905:	89 c8                	mov    %ecx,%eax
80105907:	57                   	push   %edi
80105908:	bf fa 03 00 00       	mov    $0x3fa,%edi
8010590d:	56                   	push   %esi
8010590e:	89 fa                	mov    %edi,%edx
80105910:	53                   	push   %ebx
80105911:	83 ec 1c             	sub    $0x1c,%esp
80105914:	ee                   	out    %al,(%dx)
80105915:	be fb 03 00 00       	mov    $0x3fb,%esi
8010591a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010591f:	89 f2                	mov    %esi,%edx
80105921:	ee                   	out    %al,(%dx)
80105922:	b8 0c 00 00 00       	mov    $0xc,%eax
80105927:	b2 f8                	mov    $0xf8,%dl
80105929:	ee                   	out    %al,(%dx)
8010592a:	bb f9 03 00 00       	mov    $0x3f9,%ebx
8010592f:	89 c8                	mov    %ecx,%eax
80105931:	89 da                	mov    %ebx,%edx
80105933:	ee                   	out    %al,(%dx)
80105934:	b8 03 00 00 00       	mov    $0x3,%eax
80105939:	89 f2                	mov    %esi,%edx
8010593b:	ee                   	out    %al,(%dx)
8010593c:	b2 fc                	mov    $0xfc,%dl
8010593e:	89 c8                	mov    %ecx,%eax
80105940:	ee                   	out    %al,(%dx)
80105941:	b8 01 00 00 00       	mov    $0x1,%eax
...
8010594b:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
8010594c:	3c ff                	cmp    $0xff,%al
8010594e:	74 42                	je     80105992 <uartinit+0x92>
    return;
  uart = 1;
80105950:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105957:	00 00 00 
8010595a:	89 fa                	mov    %edi,%edx
8010595c:	ec                   	in     (%dx),%al
8010595d:	b2 f8                	mov    $0xf8,%dl
8010595f:	ec                   	in     (%dx),%al
...
80105960:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105967:	00 

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105968:	bb 20 76 10 80       	mov    $0x80107620,%ebx
  ...
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
8010596d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105974:	e8 37 c9 ff ff       	call   801022b0 <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105979:	b8 78 00 00 00       	mov    $0x78,%eax
...
80105983:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105986:	e8 25 ff ff ff       	call   801058b0 <uartputc>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
...
80105990:	75 ee                	jne    80105980 <uartinit+0x80>
    uartputc(*p);
}
...
801059a6:	c7 04 24 80 58 10 80 	movl   $0x80105880,(%esp)
...
801059b6:	6a 00                	push   $0x0
  jmp alltraps
801059b8:	e9 5c fb ff ff       	jmp    80105519 <alltraps>
...
801059bf:	6a 01                	push   $0x1
  jmp alltraps
801059c1:	e9 53 fb ff ff       	jmp    80105519 <alltraps>
...
801059c8:	6a 02                	push   $0x2
  jmp alltraps
801059ca:	e9 4a fb ff ff       	jmp    80105519 <alltraps>
...
801059d1:	6a 03                	push   $0x3
  jmp alltraps
801059d3:	e9 41 fb ff ff       	jmp    80105519 <alltraps>
...
801059da:	6a 04                	push   $0x4
  jmp alltraps
801059dc:	e9 38 fb ff ff       	jmp    80105519 <alltraps>
...
801059e3:	6a 05                	push   $0x5
  jmp alltraps
801059e5:	e9 2f fb ff ff       	jmp    80105519 <alltraps>
...
801059ec:	6a 06                	push   $0x6
  jmp alltraps
801059ee:	e9 26 fb ff ff       	jmp    80105519 <alltraps>
...
801059f5:	6a 07                	push   $0x7
  jmp alltraps
801059f7:	e9 1d fb ff ff       	jmp    80105519 <alltraps>
...
801059fc:	6a 08                	push   $0x8
  jmp alltraps
801059fe:	e9 16 fb ff ff       	jmp    80105519 <alltraps>
...
80105a05:	6a 09                	push   $0x9
  jmp alltraps
80105a07:	e9 0d fb ff ff       	jmp    80105519 <alltraps>
...
80105a0c:	6a 0a                	push   $0xa
  jmp alltraps
80105a0e:	e9 06 fb ff ff       	jmp    80105519 <alltraps>
...
80105a13:	6a 0b                	push   $0xb
  jmp alltraps
80105a15:	e9 ff fa ff ff       	jmp    80105519 <alltraps>
...
80105a1a:	6a 0c                	push   $0xc
  jmp alltraps
80105a1c:	e9 f8 fa ff ff       	jmp    80105519 <alltraps>
...
80105a21:	6a 0d                	push   $0xd
  jmp alltraps
80105a23:	e9 f1 fa ff ff       	jmp    80105519 <alltraps>
...
80105a28:	6a 0e                	push   $0xe
  jmp alltraps
80105a2a:	e9 ea fa ff ff       	jmp    80105519 <alltraps>
...
80105a31:	6a 0f                	push   $0xf
  jmp alltraps
80105a33:	e9 e1 fa ff ff       	jmp    80105519 <alltraps>
...
80105a3a:	6a 10                	push   $0x10
  jmp alltraps
80105a3c:	e9 d8 fa ff ff       	jmp    80105519 <alltraps>
...
80105a41:	6a 11                	push   $0x11
  jmp alltraps
80105a43:	e9 d1 fa ff ff       	jmp    80105519 <alltraps>
...
80105a4a:	6a 12                	push   $0x12
  jmp alltraps
80105a4c:	e9 c8 fa ff ff       	jmp    80105519 <alltraps>
...
80105a53:	6a 13                	push   $0x13
  jmp alltraps
80105a55:	e9 bf fa ff ff       	jmp    80105519 <alltraps>
...
80105a5c:	6a 14                	push   $0x14
  jmp alltraps
80105a5e:	e9 b6 fa ff ff       	jmp    80105519 <alltraps>
...
80105a65:	6a 15                	push   $0x15
  jmp alltraps
80105a67:	e9 ad fa ff ff       	jmp    80105519 <alltraps>
...
80105a6e:	6a 16                	push   $0x16
  jmp alltraps
80105a70:	e9 a4 fa ff ff       	jmp    80105519 <alltraps>
...
80105a77:	6a 17                	push   $0x17
  jmp alltraps
80105a79:	e9 9b fa ff ff       	jmp    80105519 <alltraps>
...
80105a80:	6a 18                	push   $0x18
  jmp alltraps
80105a82:	e9 92 fa ff ff       	jmp    80105519 <alltraps>
...
80105a89:	6a 19                	push   $0x19
  jmp alltraps
80105a8b:	e9 89 fa ff ff       	jmp    80105519 <alltraps>
...
80105a92:	6a 1a                	push   $0x1a
  jmp alltraps
80105a94:	e9 80 fa ff ff       	jmp    80105519 <alltraps>
...
80105a9b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a9d:	e9 77 fa ff ff       	jmp    80105519 <alltraps>
...
80105aa4:	6a 1c                	push   $0x1c
  jmp alltraps
80105aa6:	e9 6e fa ff ff       	jmp    80105519 <alltraps>
...
80105aad:	6a 1d                	push   $0x1d
  jmp alltraps
80105aaf:	e9 65 fa ff ff       	jmp    80105519 <alltraps>
...
80105ab6:	6a 1e                	push   $0x1e
  jmp alltraps
80105ab8:	e9 5c fa ff ff       	jmp    80105519 <alltraps>
...
80105abf:	6a 1f                	push   $0x1f
  jmp alltraps
80105ac1:	e9 53 fa ff ff       	jmp    80105519 <alltraps>
...
80105ac8:	6a 20                	push   $0x20
  jmp alltraps
80105aca:	e9 4a fa ff ff       	jmp    80105519 <alltraps>
...
80105ad1:	6a 21                	push   $0x21
  jmp alltraps
80105ad3:	e9 41 fa ff ff       	jmp    80105519 <alltraps>
...
80105ada:	6a 22                	push   $0x22
  jmp alltraps
80105adc:	e9 38 fa ff ff       	jmp    80105519 <alltraps>
...
80105ae3:	6a 23                	push   $0x23
  jmp alltraps
80105ae5:	e9 2f fa ff ff       	jmp    80105519 <alltraps>
...
80105aec:	6a 24                	push   $0x24
  jmp alltraps
80105aee:	e9 26 fa ff ff       	jmp    80105519 <alltraps>
...
80105af5:	6a 25                	push   $0x25
  jmp alltraps
80105af7:	e9 1d fa ff ff       	jmp    80105519 <alltraps>
...
80105afe:	6a 26                	push   $0x26
  jmp alltraps
80105b00:	e9 14 fa ff ff       	jmp    80105519 <alltraps>
...
80105b07:	6a 27                	push   $0x27
  jmp alltraps
80105b09:	e9 0b fa ff ff       	jmp    80105519 <alltraps>
...
80105b10:	6a 28                	push   $0x28
  jmp alltraps
80105b12:	e9 02 fa ff ff       	jmp    80105519 <alltraps>
...
80105b19:	6a 29                	push   $0x29
  jmp alltraps
80105b1b:	e9 f9 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b22:	6a 2a                	push   $0x2a
  jmp alltraps
80105b24:	e9 f0 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b2b:	6a 2b                	push   $0x2b
  jmp alltraps
80105b2d:	e9 e7 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b34:	6a 2c                	push   $0x2c
  jmp alltraps
80105b36:	e9 de f9 ff ff       	jmp    80105519 <alltraps>
...
80105b3d:	6a 2d                	push   $0x2d
  jmp alltraps
80105b3f:	e9 d5 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b46:	6a 2e                	push   $0x2e
  jmp alltraps
80105b48:	e9 cc f9 ff ff       	jmp    80105519 <alltraps>
...
80105b4f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b51:	e9 c3 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b58:	6a 30                	push   $0x30
  jmp alltraps
80105b5a:	e9 ba f9 ff ff       	jmp    80105519 <alltraps>
...
80105b61:	6a 31                	push   $0x31
  jmp alltraps
80105b63:	e9 b1 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b6a:	6a 32                	push   $0x32
  jmp alltraps
80105b6c:	e9 a8 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b73:	6a 33                	push   $0x33
  jmp alltraps
80105b75:	e9 9f f9 ff ff       	jmp    80105519 <alltraps>
...
80105b7c:	6a 34                	push   $0x34
  jmp alltraps
80105b7e:	e9 96 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b85:	6a 35                	push   $0x35
  jmp alltraps
80105b87:	e9 8d f9 ff ff       	jmp    80105519 <alltraps>
...
80105b8e:	6a 36                	push   $0x36
  jmp alltraps
80105b90:	e9 84 f9 ff ff       	jmp    80105519 <alltraps>
...
80105b97:	6a 37                	push   $0x37
  jmp alltraps
80105b99:	e9 7b f9 ff ff       	jmp    80105519 <alltraps>
...
80105ba0:	6a 38                	push   $0x38
  jmp alltraps
80105ba2:	e9 72 f9 ff ff       	jmp    80105519 <alltraps>
...
80105ba9:	6a 39                	push   $0x39
  jmp alltraps
80105bab:	e9 69 f9 ff ff       	jmp    80105519 <alltraps>
...
80105bb2:	6a 3a                	push   $0x3a
  jmp alltraps
80105bb4:	e9 60 f9 ff ff       	jmp    80105519 <alltraps>
...
80105bbb:	6a 3b                	push   $0x3b
  jmp alltraps
80105bbd:	e9 57 f9 ff ff       	jmp    80105519 <alltraps>
...
80105bc4:	6a 3c                	push   $0x3c
  jmp alltraps
80105bc6:	e9 4e f9 ff ff       	jmp    80105519 <alltraps>
...
80105bcd:	6a 3d                	push   $0x3d
  jmp alltraps
80105bcf:	e9 45 f9 ff ff       	jmp    80105519 <alltraps>
...
80105bd6:	6a 3e                	push   $0x3e
  jmp alltraps
80105bd8:	e9 3c f9 ff ff       	jmp    80105519 <alltraps>
...
80105bdf:	6a 3f                	push   $0x3f
  jmp alltraps
80105be1:	e9 33 f9 ff ff       	jmp    80105519 <alltraps>
...
80105be8:	6a 40                	push   $0x40
  jmp alltraps
80105bea:	e9 2a f9 ff ff       	jmp    80105519 <alltraps>
...
80105bf1:	6a 41                	push   $0x41
  jmp alltraps
80105bf3:	e9 21 f9 ff ff       	jmp    80105519 <alltraps>
...
80105bfa:	6a 42                	push   $0x42
  jmp alltraps
80105bfc:	e9 18 f9 ff ff       	jmp    80105519 <alltraps>
...
80105c03:	6a 43                	push   $0x43
  jmp alltraps
80105c05:	e9 0f f9 ff ff       	jmp    80105519 <alltraps>
...
80105c0c:	6a 44                	push   $0x44
  jmp alltraps
80105c0e:	e9 06 f9 ff ff       	jmp    80105519 <alltraps>
...
80105c15:	6a 45                	push   $0x45
  jmp alltraps
80105c17:	e9 fd f8 ff ff       	jmp    80105519 <alltraps>
...
80105c1e:	6a 46                	push   $0x46
  jmp alltraps
80105c20:	e9 f4 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c27:	6a 47                	push   $0x47
  jmp alltraps
80105c29:	e9 eb f8 ff ff       	jmp    80105519 <alltraps>
...
80105c30:	6a 48                	push   $0x48
  jmp alltraps
80105c32:	e9 e2 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c39:	6a 49                	push   $0x49
  jmp alltraps
80105c3b:	e9 d9 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c42:	6a 4a                	push   $0x4a
  jmp alltraps
80105c44:	e9 d0 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c4b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c4d:	e9 c7 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c54:	6a 4c                	push   $0x4c
  jmp alltraps
80105c56:	e9 be f8 ff ff       	jmp    80105519 <alltraps>
...
80105c5d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c5f:	e9 b5 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c66:	6a 4e                	push   $0x4e
  jmp alltraps
80105c68:	e9 ac f8 ff ff       	jmp    80105519 <alltraps>
...
80105c6f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c71:	e9 a3 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c78:	6a 50                	push   $0x50
  jmp alltraps
80105c7a:	e9 9a f8 ff ff       	jmp    80105519 <alltraps>
...
80105c81:	6a 51                	push   $0x51
  jmp alltraps
80105c83:	e9 91 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c8a:	6a 52                	push   $0x52
  jmp alltraps
80105c8c:	e9 88 f8 ff ff       	jmp    80105519 <alltraps>
...
80105c93:	6a 53                	push   $0x53
  jmp alltraps
80105c95:	e9 7f f8 ff ff       	jmp    80105519 <alltraps>
...
80105c9c:	6a 54                	push   $0x54
  jmp alltraps
80105c9e:	e9 76 f8 ff ff       	jmp    80105519 <alltraps>
...
80105ca5:	6a 55                	push   $0x55
  jmp alltraps
80105ca7:	e9 6d f8 ff ff       	jmp    80105519 <alltraps>
...
80105cae:	6a 56                	push   $0x56
  jmp alltraps
80105cb0:	e9 64 f8 ff ff       	jmp    80105519 <alltraps>
...
80105cb7:	6a 57                	push   $0x57
  jmp alltraps
80105cb9:	e9 5b f8 ff ff       	jmp    80105519 <alltraps>
...
80105cc0:	6a 58                	push   $0x58
  jmp alltraps
80105cc2:	e9 52 f8 ff ff       	jmp    80105519 <alltraps>
...
80105cc9:	6a 59                	push   $0x59
  jmp alltraps
80105ccb:	e9 49 f8 ff ff       	jmp    80105519 <alltraps>
...
80105cd2:	6a 5a                	push   $0x5a
  jmp alltraps
80105cd4:	e9 40 f8 ff ff       	jmp    80105519 <alltraps>
...
80105cdb:	6a 5b                	push   $0x5b
  jmp alltraps
80105cdd:	e9 37 f8 ff ff       	jmp    80105519 <alltraps>
...
80105ce4:	6a 5c                	push   $0x5c
  jmp alltraps
80105ce6:	e9 2e f8 ff ff       	jmp    80105519 <alltraps>
...
80105ced:	6a 5d                	push   $0x5d
  jmp alltraps
80105cef:	e9 25 f8 ff ff       	jmp    80105519 <alltraps>
...
80105cf6:	6a 5e                	push   $0x5e
  jmp alltraps
80105cf8:	e9 1c f8 ff ff       	jmp    80105519 <alltraps>
...
80105cff:	6a 5f                	push   $0x5f
  jmp alltraps
80105d01:	e9 13 f8 ff ff       	jmp    80105519 <alltraps>
...
80105d08:	6a 60                	push   $0x60
  jmp alltraps
80105d0a:	e9 0a f8 ff ff       	jmp    80105519 <alltraps>
...
80105d11:	6a 61                	push   $0x61
  jmp alltraps
80105d13:	e9 01 f8 ff ff       	jmp    80105519 <alltraps>
...
80105d1a:	6a 62                	push   $0x62
  jmp alltraps
80105d1c:	e9 f8 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d23:	6a 63                	push   $0x63
  jmp alltraps
80105d25:	e9 ef f7 ff ff       	jmp    80105519 <alltraps>
...
80105d2c:	6a 64                	push   $0x64
  jmp alltraps
80105d2e:	e9 e6 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d35:	6a 65                	push   $0x65
  jmp alltraps
80105d37:	e9 dd f7 ff ff       	jmp    80105519 <alltraps>
...
80105d3e:	6a 66                	push   $0x66
  jmp alltraps
80105d40:	e9 d4 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d47:	6a 67                	push   $0x67
  jmp alltraps
80105d49:	e9 cb f7 ff ff       	jmp    80105519 <alltraps>
...
80105d50:	6a 68                	push   $0x68
  jmp alltraps
80105d52:	e9 c2 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d59:	6a 69                	push   $0x69
  jmp alltraps
80105d5b:	e9 b9 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d62:	6a 6a                	push   $0x6a
  jmp alltraps
80105d64:	e9 b0 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d6b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d6d:	e9 a7 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d74:	6a 6c                	push   $0x6c
  jmp alltraps
80105d76:	e9 9e f7 ff ff       	jmp    80105519 <alltraps>
...
80105d7d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d7f:	e9 95 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d86:	6a 6e                	push   $0x6e
  jmp alltraps
80105d88:	e9 8c f7 ff ff       	jmp    80105519 <alltraps>
...
80105d8f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d91:	e9 83 f7 ff ff       	jmp    80105519 <alltraps>
...
80105d98:	6a 70                	push   $0x70
  jmp alltraps
80105d9a:	e9 7a f7 ff ff       	jmp    80105519 <alltraps>
...
80105da1:	6a 71                	push   $0x71
  jmp alltraps
80105da3:	e9 71 f7 ff ff       	jmp    80105519 <alltraps>
...
80105daa:	6a 72                	push   $0x72
  jmp alltraps
80105dac:	e9 68 f7 ff ff       	jmp    80105519 <alltraps>
...
80105db3:	6a 73                	push   $0x73
  jmp alltraps
80105db5:	e9 5f f7 ff ff       	jmp    80105519 <alltraps>
...
80105dbc:	6a 74                	push   $0x74
  jmp alltraps
80105dbe:	e9 56 f7 ff ff       	jmp    80105519 <alltraps>
...
80105dc5:	6a 75                	push   $0x75
  jmp alltraps
80105dc7:	e9 4d f7 ff ff       	jmp    80105519 <alltraps>
...
80105dce:	6a 76                	push   $0x76
  jmp alltraps
80105dd0:	e9 44 f7 ff ff       	jmp    80105519 <alltraps>
...
80105dd7:	6a 77                	push   $0x77
  jmp alltraps
80105dd9:	e9 3b f7 ff ff       	jmp    80105519 <alltraps>
...
80105de0:	6a 78                	push   $0x78
  jmp alltraps
80105de2:	e9 32 f7 ff ff       	jmp    80105519 <alltraps>
...
80105de9:	6a 79                	push   $0x79
  jmp alltraps
80105deb:	e9 29 f7 ff ff       	jmp    80105519 <alltraps>
...
80105df2:	6a 7a                	push   $0x7a
  jmp alltraps
80105df4:	e9 20 f7 ff ff       	jmp    80105519 <alltraps>
...
80105dfb:	6a 7b                	push   $0x7b
  jmp alltraps
80105dfd:	e9 17 f7 ff ff       	jmp    80105519 <alltraps>
...
80105e04:	6a 7c                	push   $0x7c
  jmp alltraps
80105e06:	e9 0e f7 ff ff       	jmp    80105519 <alltraps>
...
80105e0d:	6a 7d                	push   $0x7d
  jmp alltraps
80105e0f:	e9 05 f7 ff ff       	jmp    80105519 <alltraps>
...
80105e16:	6a 7e                	push   $0x7e
  jmp alltraps
80105e18:	e9 fc f6 ff ff       	jmp    80105519 <alltraps>
...
80105e1f:	6a 7f                	push   $0x7f
  jmp alltraps
80105e21:	e9 f3 f6 ff ff       	jmp    80105519 <alltraps>
...
80105e28:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105e2d:	e9 e7 f6 ff ff       	jmp    80105519 <alltraps>
...
80105e34:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105e39:	e9 db f6 ff ff       	jmp    80105519 <alltraps>
...
80105e40:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105e45:	e9 cf f6 ff ff       	jmp    80105519 <alltraps>
...
80105e4c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105e51:	e9 c3 f6 ff ff       	jmp    80105519 <alltraps>
...
80105e58:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105e5d:	e9 b7 f6 ff ff       	jmp    80105519 <alltraps>
...
80105e64:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e69:	e9 ab f6 ff ff       	jmp    80105519 <alltraps>
...
80105e70:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e75:	e9 9f f6 ff ff       	jmp    80105519 <alltraps>
...
80105e7c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e81:	e9 93 f6 ff ff       	jmp    80105519 <alltraps>
...
80105e88:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e8d:	e9 87 f6 ff ff       	jmp    80105519 <alltraps>
...
80105e94:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e99:	e9 7b f6 ff ff       	jmp    80105519 <alltraps>
...
80105ea0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105ea5:	e9 6f f6 ff ff       	jmp    80105519 <alltraps>
...
80105eac:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105eb1:	e9 63 f6 ff ff       	jmp    80105519 <alltraps>
...
80105eb8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105ebd:	e9 57 f6 ff ff       	jmp    80105519 <alltraps>
...
80105ec4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105ec9:	e9 4b f6 ff ff       	jmp    80105519 <alltraps>
...
80105ed0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105ed5:	e9 3f f6 ff ff       	jmp    80105519 <alltraps>
...
80105edc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105ee1:	e9 33 f6 ff ff       	jmp    80105519 <alltraps>
...
80105ee8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105eed:	e9 27 f6 ff ff       	jmp    80105519 <alltraps>
...
80105ef4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105ef9:	e9 1b f6 ff ff       	jmp    80105519 <alltraps>
...
80105f00:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105f05:	e9 0f f6 ff ff       	jmp    80105519 <alltraps>
...
80105f0c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105f11:	e9 03 f6 ff ff       	jmp    80105519 <alltraps>
...
80105f18:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105f1d:	e9 f7 f5 ff ff       	jmp    80105519 <alltraps>
...
80105f24:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105f29:	e9 eb f5 ff ff       	jmp    80105519 <alltraps>
...
80105f30:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105f35:	e9 df f5 ff ff       	jmp    80105519 <alltraps>
...
80105f3c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105f41:	e9 d3 f5 ff ff       	jmp    80105519 <alltraps>
...
80105f48:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105f4d:	e9 c7 f5 ff ff       	jmp    80105519 <alltraps>
...
80105f54:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105f59:	e9 bb f5 ff ff       	jmp    80105519 <alltraps>
...
80105f60:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f65:	e9 af f5 ff ff       	jmp    80105519 <alltraps>
...
80105f6c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f71:	e9 a3 f5 ff ff       	jmp    80105519 <alltraps>
...
80105f78:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f7d:	e9 97 f5 ff ff       	jmp    80105519 <alltraps>
...
80105f84:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f89:	e9 8b f5 ff ff       	jmp    80105519 <alltraps>
...
80105f90:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f95:	e9 7f f5 ff ff       	jmp    80105519 <alltraps>
...
80105f9c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105fa1:	e9 73 f5 ff ff       	jmp    80105519 <alltraps>
...
80105fa8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105fad:	e9 67 f5 ff ff       	jmp    80105519 <alltraps>
...
80105fb4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105fb9:	e9 5b f5 ff ff       	jmp    80105519 <alltraps>
...
80105fc0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105fc5:	e9 4f f5 ff ff       	jmp    80105519 <alltraps>
...
80105fcc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105fd1:	e9 43 f5 ff ff       	jmp    80105519 <alltraps>
...
80105fd8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105fdd:	e9 37 f5 ff ff       	jmp    80105519 <alltraps>
...
80105fe4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105fe9:	e9 2b f5 ff ff       	jmp    80105519 <alltraps>
...
80105ff0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105ff5:	e9 1f f5 ff ff       	jmp    80105519 <alltraps>
...
80105ffc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106001:	e9 13 f5 ff ff       	jmp    80105519 <alltraps>
...
80106008:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010600d:	e9 07 f5 ff ff       	jmp    80105519 <alltraps>
...
80106014:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106019:	e9 fb f4 ff ff       	jmp    80105519 <alltraps>
...
80106020:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106025:	e9 ef f4 ff ff       	jmp    80105519 <alltraps>
...
8010602c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106031:	e9 e3 f4 ff ff       	jmp    80105519 <alltraps>
...
80106038:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010603d:	e9 d7 f4 ff ff       	jmp    80105519 <alltraps>
...
80106044:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106049:	e9 cb f4 ff ff       	jmp    80105519 <alltraps>
...
80106050:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106055:	e9 bf f4 ff ff       	jmp    80105519 <alltraps>
...
8010605c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106061:	e9 b3 f4 ff ff       	jmp    80105519 <alltraps>
...
80106068:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010606d:	e9 a7 f4 ff ff       	jmp    80105519 <alltraps>
...
80106074:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106079:	e9 9b f4 ff ff       	jmp    80105519 <alltraps>
...
80106080:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106085:	e9 8f f4 ff ff       	jmp    80105519 <alltraps>
...
8010608c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106091:	e9 83 f4 ff ff       	jmp    80105519 <alltraps>
...
80106098:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010609d:	e9 77 f4 ff ff       	jmp    80105519 <alltraps>
...
801060a4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801060a9:	e9 6b f4 ff ff       	jmp    80105519 <alltraps>
...
801060b0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801060b5:	e9 5f f4 ff ff       	jmp    80105519 <alltraps>
...
801060bc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801060c1:	e9 53 f4 ff ff       	jmp    80105519 <alltraps>
...
801060c8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801060cd:	e9 47 f4 ff ff       	jmp    80105519 <alltraps>
...
801060d4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801060d9:	e9 3b f4 ff ff       	jmp    80105519 <alltraps>
...
801060e0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801060e5:	e9 2f f4 ff ff       	jmp    80105519 <alltraps>
...
801060ec:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801060f1:	e9 23 f4 ff ff       	jmp    80105519 <alltraps>
...
801060f8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801060fd:	e9 17 f4 ff ff       	jmp    80105519 <alltraps>
...
80106104:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106109:	e9 0b f4 ff ff       	jmp    80105519 <alltraps>
...
80106110:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106115:	e9 ff f3 ff ff       	jmp    80105519 <alltraps>
...
8010611c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106121:	e9 f3 f3 ff ff       	jmp    80105519 <alltraps>
...
80106128:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010612d:	e9 e7 f3 ff ff       	jmp    80105519 <alltraps>
...
80106134:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106139:	e9 db f3 ff ff       	jmp    80105519 <alltraps>
...
80106140:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106145:	e9 cf f3 ff ff       	jmp    80105519 <alltraps>
...
8010614c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106151:	e9 c3 f3 ff ff       	jmp    80105519 <alltraps>
...
80106158:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010615d:	e9 b7 f3 ff ff       	jmp    80105519 <alltraps>
...
80106164:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106169:	e9 ab f3 ff ff       	jmp    80105519 <alltraps>
...
80106170:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106175:	e9 9f f3 ff ff       	jmp    80105519 <alltraps>
...
8010617c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106181:	e9 93 f3 ff ff       	jmp    80105519 <alltraps>
...
80106188:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010618d:	e9 87 f3 ff ff       	jmp    80105519 <alltraps>
...
80106194:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106199:	e9 7b f3 ff ff       	jmp    80105519 <alltraps>
...
801061a0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801061a5:	e9 6f f3 ff ff       	jmp    80105519 <alltraps>
...
801061ac:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801061b1:	e9 63 f3 ff ff       	jmp    80105519 <alltraps>
...
801061b8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801061bd:	e9 57 f3 ff ff       	jmp    80105519 <alltraps>
...
801061c4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801061c9:	e9 4b f3 ff ff       	jmp    80105519 <alltraps>
...
801061d0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801061d5:	e9 3f f3 ff ff       	jmp    80105519 <alltraps>
...
801061dc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801061e1:	e9 33 f3 ff ff       	jmp    80105519 <alltraps>
...
801061e8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801061ed:	e9 27 f3 ff ff       	jmp    80105519 <alltraps>
...
801061f4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801061f9:	e9 1b f3 ff ff       	jmp    80105519 <alltraps>
...
80106200:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106205:	e9 0f f3 ff ff       	jmp    80105519 <alltraps>
...
8010620c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106211:	e9 03 f3 ff ff       	jmp    80105519 <alltraps>
...
80106218:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010621d:	e9 f7 f2 ff ff       	jmp    80105519 <alltraps>
...
80106224:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106229:	e9 eb f2 ff ff       	jmp    80105519 <alltraps>
...
80106230:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106235:	e9 df f2 ff ff       	jmp    80105519 <alltraps>
...
8010623c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106241:	e9 d3 f2 ff ff       	jmp    80105519 <alltraps>
...
80106248:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010624d:	e9 c7 f2 ff ff       	jmp    80105519 <alltraps>
...
80106254:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106259:	e9 bb f2 ff ff       	jmp    80105519 <alltraps>
...
80106260:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106265:	e9 af f2 ff ff       	jmp    80105519 <alltraps>
...
8010626c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106271:	e9 a3 f2 ff ff       	jmp    80105519 <alltraps>
...
80106278:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010627d:	e9 97 f2 ff ff       	jmp    80105519 <alltraps>
...
80106284:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106289:	e9 8b f2 ff ff       	jmp    80105519 <alltraps>
...
80106290:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106295:	e9 7f f2 ff ff       	jmp    80105519 <alltraps>
...
8010629c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801062a1:	e9 73 f2 ff ff       	jmp    80105519 <alltraps>
...
801062a8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801062ad:	e9 67 f2 ff ff       	jmp    80105519 <alltraps>
...
801062b4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801062b9:	e9 5b f2 ff ff       	jmp    80105519 <alltraps>
...
801062c0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801062c5:	e9 4f f2 ff ff       	jmp    80105519 <alltraps>
...
801062cc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801062d1:	e9 43 f2 ff ff       	jmp    80105519 <alltraps>
...
801062d8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801062dd:	e9 37 f2 ff ff       	jmp    80105519 <alltraps>
...
801062e4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801062e9:	e9 2b f2 ff ff       	jmp    80105519 <alltraps>
...
801062f0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801062f5:	e9 1f f2 ff ff       	jmp    80105519 <alltraps>
...
801062fc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106301:	e9 13 f2 ff ff       	jmp    80105519 <alltraps>
...
80106308:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010630d:	e9 07 f2 ff ff       	jmp    80105519 <alltraps>
...
80106314:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106319:	e9 fb f1 ff ff       	jmp    80105519 <alltraps>
...
80106320:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106325:	e9 ef f1 ff ff       	jmp    80105519 <alltraps>
...
8010632c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106331:	e9 e3 f1 ff ff       	jmp    80105519 <alltraps>
...
80106338:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010633d:	e9 d7 f1 ff ff       	jmp    80105519 <alltraps>
...
80106344:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106349:	e9 cb f1 ff ff       	jmp    80105519 <alltraps>
...
80106350:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106355:	e9 bf f1 ff ff       	jmp    80105519 <alltraps>
...
8010635c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106361:	e9 b3 f1 ff ff       	jmp    80105519 <alltraps>
...
80106368:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010636d:	e9 a7 f1 ff ff       	jmp    80105519 <alltraps>
...
80106374:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106379:	e9 9b f1 ff ff       	jmp    80105519 <alltraps>
...
80106380:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106385:	e9 8f f1 ff ff       	jmp    80105519 <alltraps>
...
8010638c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106391:	e9 83 f1 ff ff       	jmp    80105519 <alltraps>
...
80106398:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010639d:	e9 77 f1 ff ff       	jmp    80105519 <alltraps>
...
801063a4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801063a9:	e9 6b f1 ff ff       	jmp    80105519 <alltraps>
...
801063b0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801063b5:	e9 5f f1 ff ff       	jmp    80105519 <alltraps>
...
801063bc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801063c1:	e9 53 f1 ff ff       	jmp    80105519 <alltraps>
...
801063c8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801063cd:	e9 47 f1 ff ff       	jmp    80105519 <alltraps>
...
801063d4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801063d9:	e9 3b f1 ff ff       	jmp    80105519 <alltraps>
...
801063e0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063e5:	e9 2f f1 ff ff       	jmp    80105519 <alltraps>
...
801063ec:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063f1:	e9 23 f1 ff ff       	jmp    80105519 <alltraps>
...
801063f8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063fd:	e9 17 f1 ff ff       	jmp    80105519 <alltraps>
...
80106404:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106409:	e9 0b f1 ff ff       	jmp    80105519 <alltraps>
...
80106410:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106415:	e9 ff f0 ff ff       	jmp    80105519 <alltraps>
...
8010641c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106421:	e9 f3 f0 ff ff       	jmp    80105519 <alltraps>
...
80106474:	e8 27 c0 ff ff       	call   801024a0 <kalloc>
...
80106492:	e8 29 df ff ff       	call   801043c0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801065ca:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
801065cb:	c7 04 24 a6 6f 10 80 	movl   $0x80106fa6,(%esp)
...
801065e3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801065e6:	e8 a5 d0 ff ff       	call   80103690 <cpuid>
...
8010668f:	c9                   	leave  
80106690:	c3                   	ret    
80106691:	eb 0d                	jmp    801066a0 <switchkvm>
80106693:	90                   	nop
80106694:	90                   	nop
80106695:	90                   	nop
80106696:	90                   	nop
...
801066a0:	a1 a4 ba 11 80       	mov    0x8011baa4,%eax
...
801066c9:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
801066cc:	85 f6                	test   %esi,%esi
801066ce:	0f 84 cd 00 00 00    	je     801067a1 <switchuvm+0xe1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
801066d4:	8b 46 08             	mov    0x8(%esi),%eax
801066d7:	85 c0                	test   %eax,%eax
801066d9:	0f 84 da 00 00 00    	je     801067b9 <switchuvm+0xf9>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
801066df:	8b 7e 04             	mov    0x4(%esi),%edi
801066e2:	85 ff                	test   %edi,%edi
801066e4:	0f 84 c3 00 00 00    	je     801067ad <switchuvm+0xed>
    panic("switchuvm: no pgdir");

  pushcli();
801066ea:	e8 21 db ff ff       	call   80104210 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801066ef:	e8 1c cf ff ff       	call   80103610 <mycpu>
801066f4:	89 c3                	mov    %eax,%ebx
801066f6:	e8 15 cf ff ff       	call   80103610 <mycpu>
801066fb:	89 c7                	mov    %eax,%edi
801066fd:	e8 0e cf ff ff       	call   80103610 <mycpu>
80106702:	83 c7 08             	add    $0x8,%edi
80106705:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106708:	e8 03 cf ff ff       	call   80103610 <mycpu>
8010670d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106710:	ba 67 00 00 00       	mov    $0x67,%edx
80106715:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
8010671c:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106723:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
8010672a:	83 c1 08             	add    $0x8,%ecx
8010672d:	c1 e9 10             	shr    $0x10,%ecx
80106730:	83 c0 08             	add    $0x8,%eax
80106733:	c1 e8 18             	shr    $0x18,%eax
80106736:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
8010673c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106743:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
...
80106749:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    panic("switchuvm: no pgdir");
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010674e:	e8 bd ce ff ff       	call   80103610 <mycpu>
80106753:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010675a:	e8 b1 ce ff ff       	call   80103610 <mycpu>
8010675f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106764:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106768:	e8 a3 ce ff ff       	call   80103610 <mycpu>
8010676d:	8b 56 08             	mov    0x8(%esi),%edx
80106770:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106776:	89 48 0c             	mov    %ecx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106779:	e8 92 ce ff ff       	call   80103610 <mycpu>
8010677e:	66 89 58 6e          	mov    %bx,0x6e(%eax)
}
...
80106782:	b8 28 00 00 00       	mov    $0x28,%eax
80106787:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
8010678a:	8b 46 04             	mov    0x4(%esi),%eax
8010678d:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106792:	0f 22 d8             	mov    %eax,%cr3
  popcli();
}
80106795:	83 c4 1c             	add    $0x1c,%esp
80106798:	5b                   	pop    %ebx
80106799:	5e                   	pop    %esi
8010679a:	5f                   	pop    %edi
8010679b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010679c:	e9 af da ff ff       	jmp    80104250 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
801067a1:	c7 04 24 2e 76 10 80 	movl   $0x8010762e,(%esp)
801067a8:	e8 b3 9b ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
801067ad:	c7 04 24 59 76 10 80 	movl   $0x80107659,(%esp)
801067b4:	e8 a7 9b ff ff       	call   80100360 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
801067b9:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
801067c0:	e8 9b 9b ff ff       	call   80100360 <panic>
801067c5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
801067d9:	8b 75 10             	mov    0x10(%ebp),%esi
801067dc:	8b 45 08             	mov    0x8(%ebp),%eax
801067df:	8b 7d 0c             	mov    0xc(%ebp),%edi
  char *mem;

  if(sz >= PGSIZE)
801067e2:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
801067e8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  char *mem;

  if(sz >= PGSIZE)
801067eb:	77 54                	ja     80106841 <inituvm+0x71>
    panic("inituvm: more than a page");
  mem = kalloc();
801067ed:	e8 ae bc ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
801067f2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801067f9:	00 
...
80106801:	00 
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
80106802:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106804:	89 04 24             	mov    %eax,(%esp)
80106807:	e8 b4 db ff ff       	call   801043c0 <memset>
...
8010681a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010681d:	31 d2                	xor    %edx,%edx
8010681f:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106826:	00 
80106827:	e8 94 fc ff ff       	call   801064c0 <mappages>
  memmove(mem, init, sz);
8010682c:	89 75 10             	mov    %esi,0x10(%ebp)
8010682f:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106832:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
8010683b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010683c:	e9 1f dc ff ff       	jmp    80104460 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106841:	c7 04 24 6d 76 10 80 	movl   $0x8010766d,(%esp)
...
80106893:	e8 98 fb ff ff       	call   80106430 <walkpgdir>
...
801068cd:	e8 8e b0 ff ff       	call   80101960 <readi>
...
801068f1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801068f2:	c7 04 24 87 76 10 80 	movl   $0x80107687,(%esp)
801068f9:	e8 62 9a ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801068fe:	c7 04 24 28 77 10 80 	movl   $0x80107728,(%esp)
...
8010691e:	0f 88 7e 00 00 00    	js     801069a2 <allocuvm+0x92>
    return 0;
  if(newsz < oldsz)
...
80106927:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
8010692a:	72 78                	jb     801069a4 <allocuvm+0x94>
    return oldsz;

  a = PGROUNDUP(oldsz);
8010692c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106932:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106938:	39 df                	cmp    %ebx,%edi
8010693a:	77 4a                	ja     80106986 <allocuvm+0x76>
8010693c:	eb 72                	jmp    801069b0 <allocuvm+0xa0>
...
80106953:	e8 68 da ff ff       	call   801043c0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106958:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010695e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106963:	89 04 24             	mov    %eax,(%esp)
80106966:	8b 45 08             	mov    0x8(%ebp),%eax
80106969:	89 da                	mov    %ebx,%edx
8010696b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106972:	00 
80106973:	e8 48 fb ff ff       	call   801064c0 <mappages>
80106978:	85 c0                	test   %eax,%eax
8010697a:	78 44                	js     801069c0 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
8010697c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106982:	39 df                	cmp    %ebx,%edi
80106984:	76 2a                	jbe    801069b0 <allocuvm+0xa0>
    mem = kalloc();
80106986:	e8 15 bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
8010698d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
8010698f:	75 af                	jne    80106940 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106991:	c7 04 24 a5 76 10 80 	movl   $0x801076a5,(%esp)
...
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  ...
  if(newsz >= oldsz)
8010699d:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801069a0:	77 48                	ja     801069ea <allocuvm+0xda>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      ...
      kfree(mem);
      return 0;
801069a2:	31 c0                	xor    %eax,%eax
    }
  }
  return newsz;
}
801069a4:	83 c4 1c             	add    $0x1c,%esp
801069a7:	5b                   	pop    %ebx
801069a8:	5e                   	pop    %esi
801069a9:	5f                   	pop    %edi
801069aa:	5d                   	pop    %ebp
...
801069b0:	83 c4 1c             	add    $0x1c,%esp
...
801069ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
801069c0:	c7 04 24 bd 76 10 80 	movl   $0x801076bd,(%esp)
...
801069cf:	76 0d                	jbe    801069de <allocuvm+0xce>
801069d1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801069d4:	89 fa                	mov    %edi,%edx
801069d6:	8b 45 08             	mov    0x8(%ebp),%eax
801069d9:	e8 62 fb ff ff       	call   80106540 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
801069e1:	e8 0a b9 ff ff       	call   801022f0 <kfree>
      return 0;
801069e6:	31 c0                	xor    %eax,%eax
801069e8:	eb ba                	jmp    801069a4 <allocuvm+0x94>
801069ea:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801069ed:	89 fa                	mov    %edi,%edx
801069ef:	8b 45 08             	mov    0x8(%ebp),%eax
801069f2:	e8 49 fb ff ff       	call   80106540 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
801069f9:	eb a9                	jmp    801069a4 <allocuvm+0x94>
801069fb:	90                   	nop
...
80106a10:	5d                   	pop    %ebp
80106a11:	e9 2a fb ff ff       	jmp    80106540 <deallocuvm.part.0>
...
80106a3a:	e8 01 fb ff ff       	call   80106540 <deallocuvm.part.0>
...
80106a6d:	e8 7e b8 ff ff       	call   801022f0 <kfree>
  uint i;
...
80106a82:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106a83:	e9 68 b8 ff ff       	jmp    801022f0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106a88:	c7 04 24 d9 76 10 80 	movl   $0x801076d9,(%esp)
...
80106aa8:	e8 f3 b9 ff ff       	call   801024a0 <kalloc>
80106aad:	85 c0                	test   %eax,%eax
80106aaf:	89 c6                	mov    %eax,%esi
80106ab1:	74 6d                	je     80106b20 <setupkvm+0x80>
    return 0;
...
80106acb:	e8 f0 d8 ff ff       	call   801043c0 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106ae6:	e8 d5 f9 ff ff       	call   801064c0 <mappages>
...
80106b04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80106b08:	89 34 24             	mov    %esi,(%esp)
80106b0b:	e8 10 ff ff ff       	call   80106a20 <freevm>
      return 0;
    }
  return pgdir;
}
...
80106b22:	eb d8                	jmp    80106afc <setupkvm+0x5c>
...
80106b3b:	a3 a4 ba 11 80       	mov    %eax,0x8011baa4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106b5e:	e8 cd f8 ff ff       	call   80106430 <walkpgdir>
  if(pte == 0)
...
80106b6b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106b6c:	c7 04 24 ea 76 10 80 	movl   $0x801076ea,(%esp)
...
80106b93:	0f 84 b9 00 00 00    	je     80106c52 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b99:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b9c:	85 c0                	test   %eax,%eax
80106b9e:	0f 84 94 00 00 00    	je     80106c38 <copyuvm+0xb8>
80106ba4:	31 ff                	xor    %edi,%edi
...
80106ba8:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106bae:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106bb5:	00 
80106bb6:	89 74 24 04          	mov    %esi,0x4(%esp)
80106bba:	89 04 24             	mov    %eax,(%esp)
80106bbd:	e8 9e d8 ff ff       	call   80104460 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106bc2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106bc5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106bca:	89 fa                	mov    %edi,%edx
80106bcc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bd0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106bd6:	89 04 24             	mov    %eax,(%esp)
80106bd9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106bdc:	e8 df f8 ff ff       	call   801064c0 <mappages>
80106be1:	85 c0                	test   %eax,%eax
80106be3:	78 63                	js     80106c48 <copyuvm+0xc8>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106be5:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106beb:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106bee:	76 48                	jbe    80106c38 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106bf0:	8b 45 08             	mov    0x8(%ebp),%eax
80106bf3:	31 c9                	xor    %ecx,%ecx
80106bf5:	89 fa                	mov    %edi,%edx
80106bf7:	e8 34 f8 ff ff       	call   80106430 <walkpgdir>
80106bfc:	85 c0                	test   %eax,%eax
80106bfe:	74 62                	je     80106c62 <copyuvm+0xe2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106c00:	8b 00                	mov    (%eax),%eax
80106c02:	a8 01                	test   $0x1,%al
80106c04:	74 50                	je     80106c56 <copyuvm+0xd6>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c06:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106c08:	25 ff 0f 00 00       	and    $0xfff,%eax
80106c0d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c10:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106c16:	e8 85 b8 ff ff       	call   801024a0 <kalloc>
80106c1b:	85 c0                	test   %eax,%eax
80106c1d:	89 c3                	mov    %eax,%ebx
80106c1f:	75 87                	jne    80106ba8 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106c21:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c24:	89 04 24             	mov    %eax,(%esp)
80106c27:	e8 f4 fd ff ff       	call   80106a20 <freevm>
  return 0;
80106c2c:	31 c0                	xor    %eax,%eax
}
80106c2e:	83 c4 2c             	add    $0x2c,%esp
80106c31:	5b                   	pop    %ebx
80106c32:	5e                   	pop    %esi
80106c33:	5f                   	pop    %edi
80106c34:	5d                   	pop    %ebp
80106c35:	c3                   	ret    
80106c36:	66 90                	xchg   %ax,%ax
...
80106c4b:	e8 a0 b6 ff ff       	call   801022f0 <kfree>
      goto bad;
80106c50:	eb cf                	jmp    80106c21 <copyuvm+0xa1>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
...
80106c54:	eb d8                	jmp    80106c2e <copyuvm+0xae>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106c56:	c7 04 24 0e 77 10 80 	movl   $0x8010770e,(%esp)
80106c5d:	e8 fe 96 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106c62:	c7 04 24 f4 76 10 80 	movl   $0x801076f4,(%esp)
80106c69:	e8 f2 96 ff ff       	call   80100360 <panic>
...
80106c7e:	e8 ad f7 ff ff       	call   80106430 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106cec:	e8 6f d7 ff ff       	call   80104460 <memmove>
    len -= n;
    buf += n;
