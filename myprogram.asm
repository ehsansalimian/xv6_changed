...
main(void)
{
   ...
   6:	83 ec 10             	sub    $0x10,%esp
	  ...
	  printf(1, "ehsan's first user program on xv6\n");
   9:	c7 44 24 04 18 07 00 	movl   $0x718,0x4(%esp)
  10:	00 
  11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  18:	e8 93 03 00 00       	call   3b0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 349:	0f b6 92 43 07 00 00 	movzbl 0x743(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4df:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4e1:	b8 3c 07 00 00       	mov    $0x73c,%eax
...
free(void *ap)
{
 ...
 5a1:	a1 b8 09 00 00       	mov    0x9b8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5e7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5e9:	a3 b8 09 00 00       	mov    %eax,0x9b8
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 612:	a3 b8 09 00 00       	mov    %eax,0x9b8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 1d b8 09 00 00    	mov    0x9b8,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 679:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 67b:	3b 15 b8 09 00 00    	cmp    0x9b8,%edx
...
morecore(uint nu)
{
 ...
 6ad:	e8 ee fe ff ff       	call   5a0 <free>
  return freep;
 6b2:	8b 15 b8 09 00 00    	mov    0x9b8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6d4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6d7:	89 15 b8 09 00 00    	mov    %edx,0x9b8
      return (void*)(p + 1);
 ...
 6ec:	eb e9                	jmp    6d7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ee:	c7 05 b8 09 00 00 bc 	movl   $0x9bc,0x9b8
 6f5:	09 00 00 
    base.s.size = 0;
 6f8:	ba bc 09 00 00       	mov    $0x9bc,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fd:	c7 05 bc 09 00 00 bc 	movl   $0x9bc,0x9bc
 704:	09 00 00 
    base.s.size = 0;
 707:	c7 05 c0 09 00 00 00 	movl   $0x0,0x9c0
 70e:	00 00 00 
