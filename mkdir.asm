...
main(int argc, char *argv[])
{
  ...
  3f:	c7 44 24 04 8d 07 00 	movl   $0x78d,0x4(%esp)
  46:	00 
...
putc(int fd, char c)
{
 ...
 53f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 541:	b8 a9 07 00 00       	mov    $0x7a9,%eax
...
free(void *ap)
{
 ...
 601:	a1 30 0a 00 00       	mov    0xa30,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 647:	89 10                	mov    %edx,(%eax)
  freep = p;
 649:	a3 30 0a 00 00       	mov    %eax,0xa30
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 672:	a3 30 0a 00 00       	mov    %eax,0xa30
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 1d 30 0a 00 00    	mov    0xa30,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6db:	3b 15 30 0a 00 00    	cmp    0xa30,%edx
...
morecore(uint nu)
{
 ...
 70d:	e8 ee fe ff ff       	call   600 <free>
  return freep;
 712:	8b 15 30 0a 00 00    	mov    0xa30,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 734:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 737:	89 15 30 0a 00 00    	mov    %edx,0xa30
      return (void*)(p + 1);
 ...
 74c:	eb e9                	jmp    737 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 30 0a 00 00 34 	movl   $0xa34,0xa30
 755:	0a 00 00 
    base.s.size = 0;
 758:	ba 34 0a 00 00       	mov    $0xa34,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 34 0a 00 00 34 	movl   $0xa34,0xa34
 764:	0a 00 00 
    base.s.size = 0;
 767:	c7 05 38 0a 00 00 00 	movl   $0x0,0xa38
 76e:	00 00 00 
